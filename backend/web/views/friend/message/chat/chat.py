...
class MessageChatView(APIView):
    ...
    async def tts_sender(self, app, inputs, mq, ws, task_id):
        ...
        async for msg, metadata in app.astream(inputs, stream_mode="messages"): # 异步版本
    ...
    async def run_tts_tasks(self, app, inputs, mq, vocie_id):
    ...
    def worker(self, app, inputs, mq, vocie_id):
        try:
            asyncio.run(self.run_tts_tasks(app, inputs, mq, vocie_id))
        finally:
            mq.put_nowait(None)
